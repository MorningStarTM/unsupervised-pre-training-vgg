...
def conv_block(in_channels, out_channels, kernel_size=6, stride=1):
    padding = (kernel_size - 1) // 2
    return nn.Sequential(
        nn.Conv2d(in_channels, out_channels, kernel_size=kernel_size, stride=stride, padding="same"),
        nn.ReLU(inplace=True),
        nn.Conv2d(out_channels, out_channels, kernel_size=kernel_size, stride=stride, padding="same"),
        nn.ReLU(inplace=True),
        nn.Conv2d(out_channels, out_channels, kernel_size=kernel_size, stride=stride, padding="same"),
        nn.ReLU(inplace=True),
...
def upconv_block(self, in_channels, out_channels, kernel_size=6, stride=1, padding=2):
    return nn.Sequential(
        nn.ConvTranspose2d(in_channels, out_channels, kernel_size=kernel_size, stride=stride, padding="same"),
        nn.ReLU(inplace=True),
        nn.ConvTranspose2d(out_channels, out_channels, kernel_size=kernel_size, stride=stride, padding="same"),
        nn.ReLU(inplace=True),
        nn.ConvTranspose2d(out_channels, out_channels, kernel_size=kernel_size, stride=stride, padding="same"),
        nn.ReLU(inplace=True),
...
class VGGDecoder(nn.Module):
    def __init__(self):
        ...
        self.upconv1 = upconv_block(256, 256)
        self.upconv2 = upconv_block(256, 128)
        self.upconv3 = upconv_block(128, 64)
        self.upconv4 = upconv_block(64, 32)
        self.upconv5 = upconv_block(32, 16)
